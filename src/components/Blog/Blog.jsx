        ...
        <div className="blog__inner">
          <div className="blog__column large">
            <div className="blog__column__image__container">
              <img src={blog1} alt="blogImageLarge" className="blog__column__image" />
            </div>
            <div className="blog__column__content">
              <p className="blog__column__date">Sep 26, 2021</p>
              <h1 className="blog__column__title">GPT-3 and Open AI is the future. Let us exlore how it is?</h1>
