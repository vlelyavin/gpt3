      ...
      <div className="container">
        <div className="intro__inner">
          <div className="intro__content">
            <h1 className="intro__title title">Let’s Build Something amazing with GPT-3 OpenAI</h1>
            ...
            <div className="intro__inputline">
              <input type="text" className="intro__input" placeholder="Your Email Address" />
              <button className="intro__button">Get started</button>
            </div>
            <div className="intro__reviews">
              <img src={avatars} alt="avatars" className="intro__reviews__avatars" />
              <p className="intro__reviews__text">1,600 people requested access a visit in last 24 hours</p>
            </div>
          </div>
          <img className="intro__image" src={face} alt="face" />
        </div>
        <div className="intro__companies">
          <img src={companies} alt="companies" className="intro__companies__image" />
        </div>
      </div>
    </section>
  );
